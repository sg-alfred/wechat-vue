...
export default {
  ...
  data() {
    return {
      ...
      operateList: [{
          id: 0,
          icon: require('@/assets/image/operate/icon-setRemark.png'),
          name: '设置备注及标签',
        },
        {
          id: 1,
          icon: require('@/assets/image/operate/icon-starred.png'),
          name: '标为星标朋友',
        },
        {
          id: 2,
          icon: require('@/assets/image/operate/icon-moment.png'),
          name: '朋友圈设置',
        },
        {
          id: 3,
          icon: require('@/assets/image/operate/icon-shareContact.png'),
          name: '发送该名片',
        },
        {
          id: 4,
          icon: require('@/assets/image/operate/icon-report.png'),
          name: '投诉',
        },
        {
          id: 5,
          icon: require('@/assets/image/operate/icon-addToBlock.png'),
          name: '加入黑名单',
        },
        {
          id: 6,
          icon: require('@/assets/image/operate/icon-delete.png'),
          name: '删除',
        },
        {
          id: 7,
          icon: require('@/assets/image/operate/icon-addToDesk.png'),
          name: '添加到桌面',
        },
      ],
    };
  ...
  beforeMount() {
    ...
    // 点击朋友或者自己的！
    this.info =
      this.contactid === this.userinfo._id ?
      this.userinfo :
      this.isFriend ?
...
.picker {
  ...
  /* 动态过渡的效果 */
  .picker-show-enter,
  .picker-show-leave-active {
    transform: translate3d(0, 273px, 0);
  }

  .picker-show-enter-active,
  .picker-show-leave-active {
